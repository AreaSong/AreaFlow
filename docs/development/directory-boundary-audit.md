...
本文对应 backlog 任务
[`AF-P0-002 Directory Boundary Audit`](../../tasks/backlog/0-100-platform-backlog.md#af-p0-002-directory-boundary-audit)。

目标是对照 [`../product/platform-blueprint.md`](../product/platform-blueprint.md) 的长期目录边界，确认当前
AreaFlow 目录结构：
