...
本文对应 backlog 任务
[`AF-P0-003 Governance Boundary Audit`](../../tasks/backlog/0-100-platform-backlog.md#af-p0-003-governance-boundary-audit)。
...
- [`../architecture/security-permissions.md`](../architecture/security-permissions.md)
- [`../architecture/api-surface.md`](../architecture/api-surface.md)
- [`../architecture/auth-team-secret-boundary.md`](../architecture/auth-team-secret-boundary.md)
...
- [`../product/phase-backlog.md`](../product/phase-backlog.md)
