...
[`team-remote-control-boundary.md`](team-remote-control-boundary.md)；auth、API token、secret 和 remote
worker credential 的 R4 边界见 [`auth-team-secret-boundary.md`](auth-team-secret-boundary.md)。
