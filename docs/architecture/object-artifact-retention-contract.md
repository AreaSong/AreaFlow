...
[`auth-team-secret-boundary.md`](auth-team-secret-boundary.md) 的 scoped secret resolve 规则打开。
...
[`high-risk-apply-ladder.md`](high-risk-apply-ladder.md) 的 R4 restore apply 规则执行；object verifier
