...
语义见 [`release-final-gate-contract.md`](release-final-gate-contract.md)。Release Query API 只回答
...
[`completion-audit-contract.md`](completion-audit-contract.md)；release final gate `pass` 仍不能单独证明
AreaFlow 已达 100%。
...
[`auth-team-secret-boundary.md`](auth-team-secret-boundary.md)，v1.0 前不启用真实 enforcement。
Team Console 和远程控制台的控制面分层见
[`team-remote-control-boundary.md`](team-remote-control-boundary.md)；Web、Desktop 或远程 UI 的 presence
...
[`budget-quota-boundary.md`](budget-quota-boundary.md)；v1.0 Query API 只能展示 estimate / readiness /
blocked reason，不执行 quota decrement、reservation、charge 或 provider billing sync。
External integration / webhook 的边界见
[`integration-webhook-boundary.md`](integration-webhook-boundary.md)；v1.0 Query API 只能展示 integration
...
[`artifact-backup-restore-contract.md`](artifact-backup-restore-contract.md)；object backend、archive copy/upload、
GC/delete 的长期合同见
[`object-artifact-retention-contract.md`](object-artifact-retention-contract.md)。Manifest 不是 restore package。
...
[`release-final-gate-contract.md`](release-final-gate-contract.md)；即使该接口未来返回 `pass`，也只允许
...
[`plugin-marketplace-boundary.md`](plugin-marketplace-boundary.md)；该 conformance API 不安装、不启用、
...
[`worker-scheduling-contract.md`](worker-scheduling-contract.md)；v0.8 阶段合同见
...
[`high-risk-apply-ladder.md`](high-risk-apply-ladder.md)；API endpoint 存在不代表对应 rung 已打开。
...
[`operations-deployment-observability-boundary.md`](operations-deployment-observability-boundary.md)；support
...
[`auth-team-secret-boundary.md`](auth-team-secret-boundary.md) 的 R4 opening ladder。Endpoint 或 CLI
...
[`integration-webhook-boundary.md`](integration-webhook-boundary.md)；任何 external-effect command 都不能由
...
[`team-remote-control-boundary.md`](team-remote-control-boundary.md) 的 T4/T5 单独打开。
