...
边界。它补充 [`data-model-v1.md`](data-model-v1.md)、[`api-surface.md`](api-surface.md) 和
[`command-approval-contract.md`](command-approval-contract.md)。Object backend、archive copy/upload、
...
Command API 能力。打开前必须满足 [`command-approval-contract.md`](command-approval-contract.md) 的
