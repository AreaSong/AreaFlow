...
policy 见 [`high-risk-apply-ladder.md`](high-risk-apply-ladder.md)。

Auth、team、API token、secret resolve 和 remote worker credential 的具体 R4 开闸顺序见
[`auth-team-secret-boundary.md`](auth-team-secret-boundary.md)。v1.0 前只允许 schema / readiness /
...
[`budget-quota-boundary.md`](budget-quota-boundary.md)。v1.0 前 budget policy 只能作为 readiness /
...
[`integration-webhook-boundary.md`](integration-webhook-boundary.md)。v1.0 前 integration 只能作为
...
完整合同见 [`integration-webhook-boundary.md`](integration-webhook-boundary.md)。
...
真实 secret resolve 必须按 [`auth-team-secret-boundary.md`](auth-team-secret-boundary.md) 的 scoped
