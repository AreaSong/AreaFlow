...
[`../architecture/execution-opening-strategy.md`](../architecture/execution-opening-strategy.md)，并引用
[`../architecture/v0.6-worker-beta-contract.md`](../architecture/v0.6-worker-beta-contract.md) 的 scoped
