...
本文把 [`../../docs/product/phase-backlog.md`](../../docs/product/phase-backlog.md) 拆成可执行候选任务。
...
- [`../../docs/development/directory-boundary-audit.md`](../../docs/development/directory-boundary-audit.md) 目录差距清单。
- v0.4 前暂不创建空目录的理由。
...
- [`../../docs/development/governance-boundary-audit.md`](../../docs/development/governance-boundary-audit.md) governance 边界审计。
...
- [`../../docs/architecture/operations-deployment-observability-boundary.md`](../../docs/architecture/operations-deployment-observability-boundary.md)
  运维、部署和可观测性边界合同。
...
- [`../../docs/development/bootstrap-smoke-evidence.md`](../../docs/development/bootstrap-smoke-evidence.md) 最近一次 bootstrap smoke 证据。
- migration 命令可重复。
...
- [`../../docs/development/areamatrix-adapter-import-evidence.md`](../../docs/development/areamatrix-adapter-import-evidence.md) 最近一次真实 AreaMatrix 只读 metadata import 证据。
- import run 可重复。
...
- [`../../docs/development/status-projection-evidence.md`](../../docs/development/status-projection-evidence.md) 最近一次 fixture status projection apply 证据。
...
- [`../../docs/development/shadow-doctor-readiness-evidence.md`](../../docs/development/shadow-doctor-readiness-evidence.md) 最近一次 doctor/readiness/import-diff/verify-bundle 证据。
- 稳定 JSON 输出。
...
- [`../../docs/development/native-doctor-authorization-evidence.md`](../../docs/development/native-doctor-authorization-evidence.md) 最近一次 native doctor 授权边界证据。
...
- [`../../docs/development/workflow-version-authoring-evidence.md`](../../docs/development/workflow-version-authoring-evidence.md) 最近一次 workflow version authoring fixture 证据。
...
- [`../../docs/development/gate-transition-approval-evidence.md`](../../docs/development/gate-transition-approval-evidence.md) 最近一次 gate/transition/approval fixture 证据。
...
- [`../../docs/development/compatibility-shim-readiness-evidence.md`](../../docs/development/compatibility-shim-readiness-evidence.md) 最近一次 compatibility / shim readiness fixture 证据。
- compatibility query。
- shim preview。
- shim readiness gate。
...
- [`../../docs/development/authoring-cutover-apply-evidence.md`](../../docs/development/authoring-cutover-apply-evidence.md) 最近一次 authoring cutover apply fixture 证据。
...
- [`../../docs/development/runner-preview-evidence.md`](../../docs/development/runner-preview-evidence.md) 最近一次 runner preview focused smoke 证据。
...
- [`../../docs/development/run-control-evidence.md`](../../docs/development/run-control-evidence.md) 最近一次 run control focused smoke 证据。
...
阶段合同：[`../../docs/architecture/v0.6-worker-beta-contract.md`](../../docs/architecture/v0.6-worker-beta-contract.md)。
...
- [`../../docs/development/worker-lease-evidence.md`](../../docs/development/worker-lease-evidence.md) 最近一次 worker lease focused smoke 证据。
- worker register。
- heartbeat。
- lease lifecycle。
- recovery。
...
- [`../../docs/development/codex-cli-adapter-preview-evidence.md`](../../docs/development/codex-cli-adapter-preview-evidence.md) 最近一次 Codex CLI adapter preview focused smoke 证据。
...
- [`../../docs/development/execution-approval-gate-evidence.md`](../../docs/development/execution-approval-gate-evidence.md) 最近一次 execution approval gate focused smoke 证据。
...
- [`../../docs/development/fixture-execution-apply-evidence.md`](../../docs/development/fixture-execution-apply-evidence.md) 最近一次 fixture execution apply focused smoke 证据。
...
- [`../../docs/development/read-only-verify-evidence.md`](../../docs/development/read-only-verify-evidence.md) 最近一次 read-only verify focused smoke 证据。
...
- [`../../docs/development/approved-artifact-write-evidence.md`](../../docs/development/approved-artifact-write-evidence.md) 最近一次 approved artifact write focused smoke 证据。
...
- [`../../docs/development/execution-plan-preview-evidence.md`](../../docs/development/execution-plan-preview-evidence.md) 最近一次 execution plan preview focused smoke 证据。
...
- [`../../docs/development/fixture-project-write-evidence.md`](../../docs/development/fixture-project-write-evidence.md)
...
- [`../../docs/development/managed-generated-write-gate-evidence.md`](../../docs/development/managed-generated-write-gate-evidence.md)
...
- [`../../docs/development/managed-generated-write-apply-evidence.md`](../../docs/development/managed-generated-write-apply-evidence.md)
...
- [`../../docs/development/generated-write-readiness-evidence.md`](../../docs/development/generated-write-readiness-evidence.md)
...
- [`../../docs/development/generated-write-apply-beta-gate-evidence.md`](../../docs/development/generated-write-apply-beta-gate-evidence.md)
...
阶段合同见 [`../../docs/architecture/v0.7-web-dashboard-contract.md`](../../docs/architecture/v0.7-web-dashboard-contract.md)。
...
后续每推进一个阶段，都应更新 [`../../docs/development/implementation-gap-audit.md`](../../docs/development/implementation-gap-audit.md)，记录实现证据和剩余缺口。
