...
Current product boundaries:
  ...
  - projects, workflows, runs, workers, artifacts, events, audit, and operations are available
  - run control and worker run-once remain scoped by task type, permissions, approvals, and audit
  - project writes, engine calls, network access, secret resolve, restore, and publish require separate explicit authorization`)
}
