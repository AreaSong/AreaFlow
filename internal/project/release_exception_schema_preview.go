...
func releaseExceptionsTablePreview() ReleaseExceptionSchemaTable {
	return ReleaseExceptionSchemaTable{
		...
		Columns: []ReleaseExceptionSchemaColumn{
			...
			{Name: "created_by_actor_id", Type: "BIGINT", Nullable: true, Purpose: "actor that created the record"},
			{Name: "approved_by_actor_id", Type: "BIGINT", Nullable: true, Purpose: "actor that approved the record"},
