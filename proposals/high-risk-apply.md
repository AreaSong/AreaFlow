...
> Status: Proposed. 本文不授权任何真实高风险 apply。
...
[`execution-opening-strategy.md`](./execution-opening.md)、
[`auth-team-secret-boundary.md`](./auth-team-secret.md)、
[`artifact-backup-restore-contract.md`](../docs/architecture/artifact-backup-restore-contract.md)、
[`object-artifact-retention-contract.md`](../docs/architecture/object-artifact-retention-contract.md) 和
[`release-final-gate-contract.md`](../docs/architecture/release-final-gate-contract.md)、
[`plugin-marketplace-boundary.md`](./plugin-marketplace.md)、
[`team-remote-control-boundary.md`](./team-and-remote-control.md) 和
[`budget-quota-boundary.md`](./budget-and-quota.md) 和
[`integration-webhook-boundary.md`](./integrations-and-webhooks.md) 和
[`operations-deployment-observability-boundary.md`](../docs/architecture/operations-deployment-observability-boundary.md)。
...
[`auth-team-secret-boundary.md`](./auth-team-secret.md) 为准。Team console 是控制面，不是能力放大器；
...
[`team-remote-control-boundary.md`](./team-and-remote-control.md)；Team Console 的某个页面或按钮存在，
不代表对应 command rung 已打开。
Budget / quota enforcement 必须按 [`budget-quota-boundary.md`](./budget-and-quota.md) 逐级打开；
...
[`integration-webhook-boundary.md`](./integrations-and-webhooks.md) 逐级打开；callback verified 不是
...
[`operations-deployment-observability-boundary.md`](../docs/architecture/operations-deployment-observability-boundary.md) 逐级打开；
...
[`auth-team-secret-boundary.md`](./auth-team-secret.md) 完成：
...
[`object-artifact-retention-contract.md`](../docs/architecture/object-artifact-retention-contract.md) 单独开闸：
...
[`plugin-marketplace-boundary.md`](./plugin-marketplace.md)。Plugin 必须声明 capability、
