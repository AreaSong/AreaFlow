...
> Status: Proposed. 当前产品未开放 external webhook delivery 或 third-party callback execution。
...
[`auth-team-secret-boundary.md`](./auth-team-secret.md), and secret values must never enter logs, events,
